...
var ClubService = ClubService_1 = (function () {
    function ClubService(af, fa /*firebase.app.App*/) {
        this.af = af;
    ...
    ClubService.prototype.getClubs = function (name) {
        ...
        return this.af.database.list("/" + ClubService_1.CLUBS_DIR, query);
    };
    ClubService.prototype.getClub = function (key) {
        return this.af.database.object("/" + ClubService_1.CLUBS_DIR + "/" + key);
    };
    ClubService.prototype.create = function (club) {
        return this.af.database.list("/" + ClubService_1.CLUBS_DIR).push(club);
    };
    ClubService.prototype.uploadImage = function (file, name) {
        return this.storageRef.child(ClubService_1.IMAGES_DIR + "/" + name).put(file);
    };
    return ClubService;
}());
